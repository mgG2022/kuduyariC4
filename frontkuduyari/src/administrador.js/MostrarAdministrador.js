...
const CompMostrarAdministrador = () => {
    ...
    return (
        <div className='container'>
            <div className='row'>
                <div className='col'>
                    <Link to='/administrador/agregar' className='btn btn-primary mt-2 mb-2'><i className="fa-regular fa-file-circle-plus"></i></Link>
                        ...
                        <tbody>
                            {administradores.map((administrador, index) => (
                                <tr key = {index} >
                                    ...
                                    <td>
                                        <Link to={`/administrador/editar/${administrador._id}`} className='btn btn-info '><i className="fa-solid fa-pen-to-square"></i></Link>
                                        <button onClick={ ()=> eliminarAdministrador(administrador._id)} className = 'btn btn-danger'><i className="fa-solid fa-trash-xmark"></i></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
