...
const CompMostrarHistoria = () => {
    ...
    return (
        <div className='container'>
            <div className='row'>
                <div className='col'>
                    <Link to='/historia/agregar' className='btn btn-primary mt-2 mb-2'><i class="fa-regular fa-file-circle-plus"></i></Link>
                        ...
                        <tbody>
                            {historias.map((historia, index) => (
                                <tr key = {index} >
                                    ...
                                    <td>
                                        <Link to={`/historia/editar/${historia._id}`} className='btn btn-info '><i class="fa-solid fa-pen-to-square"></i></Link>
                                        <button onClick={ ()=> eliminarHistoria(historia._id)} className = 'btn btn-danger'><i class="fa-solid fa-trash-xmark"></i></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
